  ...
  return (
    <>
      <div className="flex items-center justify-center gap-2 w-full">
        <button className="flex gap-1 items-center justify-center text-center w-1/2 pg-trasparent transition-all duration-75 hover:bg-muted/80 border border-muted p-2 text-sm">
